...
namespace Assignments
{
    ...
    public class Automation
    {
        ...
        public void Assignment1()
        {
            ...
            IWebElement BuildingButton = driver.FindElement(By.XPath("//ul[@class='sub-nav']//a[contains(text(),'Building Automation')]"));
            BuildingButton.Click();

            IWebElement Newsletter = driver.FindElement(By.XPath("//ul[@class='sub-nav']//a[contains(text(),'Building Automation e-Newsletter Archive')]"));
            Newsletter.Click();
            ...
            //Printing the count and titles of all the archived News-letters displayed in list
        ...
        [Test]
        //Assignment 2 using CssSelectors
        public void Assignment2()
        {
            //Clicking on Products
            IWebElement products = driver.FindElement(By.CssSelector("li.newnav:nth-child(3)"));
            products.Click();

            //Sending the search key 
            IWebElement searchKey = driver.FindElement(By.CssSelector("#field_707"));
            searchKey.SendKeys("Weidmuller");
            IWebElement searchButton = driver.FindElement(By.CssSelector("div.search-button > a:nth-child(1)"));
            searchButton.Click();
            ...
            IWebElement categoryBox = driver.FindElement(By.CssSelector("span.selection > span.select2-selection.select2-selection--multiple"));
            categoryBox.Click();
        ...
        {
            //Placing mouse over the job search for drop down 
            ...
            //Passing parameter to get the region and its average salary 
            GetRegion("United States");
            //Passing parameter to get the preson respondents of US 
        ...
        {
            //Qutting the browser after every test execution 
            driver.Quit();
        }
